        ...
        <>
            ...
            <div className='footer-div mt-3'>
                <Container>
                    <Row>
                        <Col>
                            <h1 className='pt-3' style={{ textAlign: "center" }}>Virtual Vault</h1>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={6} sm={12} lg={6}>
                            <h4 className='pt-3' style={{ textAlign: "center" }}>About Us</h4>
                            <div style={{ textAlign: "justify" }}>
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. In praesentium voluptatem autem sed esse, consequatur assumenda nostrum animi quidem deserunt hic asperiores incidunt, facere rem doloribus quasi tempora voluptates, officia natus dolorem tempore? Placeat quod id delectus tenetur ad, magnam impedit, nisi eos illo in facere corporis voluptates quas ab odit iusto officiis aut pariatur. Totam magni iste corporis voluptates.</p>
                            </div>
                        </Col>
                    </Row>
                    <Row style={{ borderTop: "1px solid white" }}>
                        ...
                        <Col md={3} sm={12} lg={3} className='mt-4 icons-col-section'>
                            ...
                            <OverlayTrigger placement="top" overlay={tooltip("Click me")}>
                                <p className='cursor' onClick={() => setShow(true)}><FontAwesomeIcon icon={faMapPin} /></p>
                            </OverlayTrigger>
                        </Col>
                    </Row>
                </Container>
