        ...
        <Container>
            ...
            <Col md={6} sm={12} lg={6}>
              ...
              <div style={{ textAlign: "justify" }}>
                <p>
                  ...
                  praesentium voluptatem autem sed esse, consequatur assumenda
                  nostrum animi quidem deserunt hic asperiores incidunt, facere
                  rem doloribus quasi tempora voluptates, officia natus dolorem
                  tempore? Placeat quod id delectus tenetur ad, magnam impedit,
                  nisi eos illo in facere corporis voluptates quas ab odit iusto
                  officiis aut pariatur. Totam magni iste corporis voluptates.
                </p>
              </div>
            </Col>
          </Row>
          <Row style={{ borderTop: "1px solid white" }}>
            ...
            <Col md={3} sm={12} lg={3} className="mt-4 icons-col-section">
              ...
              <OverlayTrigger
                placement="top"
                overlay={tooltip("nabeelahmedamir@gmail.com")}
              >
                <p>
                  <FontAwesomeIcon
                    icon={faEnvelope}
              ...
              <OverlayTrigger
                placement="top"
                overlay={tooltip("nabeel-ahmed-amir")}
              >
                <p>
