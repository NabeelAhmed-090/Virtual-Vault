...
import { Badge, Button, Card, Col, Container, Form, FormControl, Modal, Row } from 'react-bootstrap';
    ...
    return (
        <>
            <Modal show={showPopup} onHide={handleClosePopup}>
                ...
                <>
                    {
                        loading ? <div><Loader message='Updating Game...' /></div> : (
                            <>
                                <Modal.Body>
                                        ...
                                        <Card.Body className="d-flex flex-column justify-content-between">
                                                ...
                                                <Container>
                                                    ...
                                                    <Row>
                                                        <Col md={6} lg={6} sm={12} className='mt-3'>
                                                            {newIsGameNew ? (
                                                                <Badge bg="success badge-media-style py-2" className='cursor' onClick={() => setNewIsGameNew(false)}>New</Badge>
                                                            ) : (
                                                                <Badge bg="warning badge-media-style py-2" className='cursor' onClick={() => setNewIsGameNew(true)}>Used</Badge>
                                                            )}
                                                        </Col>
                                            ...
                                            <Row className="mt-auto d-flex">
                                                <Col md={12} sm={12} lg={12}>
                                                    <Button variant="success" className='w-100 button-style-game-card' onClick={handleGameUpdate}>Update</Button>
                                                </Col>
                                            </Row>
                                        </Card.Body>
                                    </Card>
